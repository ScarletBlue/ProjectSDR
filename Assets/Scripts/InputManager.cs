...
public static class InputManager {
    ...
    {
        return Input.GetButtonDown("P1_Up_Button");
    }
    public static bool P1RightButton()
    {
        return Input.GetButtonDown("P1_Right_Button");
    }
    public static bool P1DownButton()
    {
        return Input.GetButtonDown("P1_Down_Button");
    }
    public static bool P1LeftButton()
    {
    ...
    {
        return Input.GetButtonDown("P2_Up_Button");
    }
    public static bool P2RightButton()
    {
        return Input.GetButtonDown("P2_Right_Button");
    }
    public static bool P2DownButton()
    {
        return Input.GetButtonDown("P2_Down_Button");
    }
    public static bool P2LeftButton()
    {
    ...
    {
        return Input.GetButtonDown("P3_Up_Button");
    }
    public static bool P3RightButton()
    {
        return Input.GetButtonDown("P3_Right_Button");
    }
    public static bool P3DownButton()
    {
        return Input.GetButtonDown("P3_Down_Button");
    }
    public static bool P3LeftButton()
    {
    ...
    {
        return Input.GetButtonDown("P4_Up_Button");
    }
    public static bool P4RightButton()
    {
        return Input.GetButtonDown("P4_Right_Button");
    }
    public static bool P4DownButton()
    {
        return Input.GetButtonDown("P4_Down_Button");
    }
    public static bool P4LeftButton()
    {
        return Input.GetButtonDown("P4_Left_Button");
    }
